      ...
      <main className="container mx-auto p-4">
        ...
        <section className="my-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {tasks.map(task => (
              <div key={task.id} className="task-card bg-gray-800 p-6 rounded-lg">
        ...
        <section className="my-10">
          ...
          {/* Tasks list */}
          {tasks.map(task => (
            <div key={task.id} className="flex justify-between items-center bg-gray-700 p-4 rounded-lg mb-4">
              <div>
